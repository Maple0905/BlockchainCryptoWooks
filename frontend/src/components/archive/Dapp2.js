...
const address = "0xa3AEe8BcE55BEeA1951EF834b99f3Ac60d1ABeeB";
...
export class Dapp extends React.Component {
  ...
  async _intializeEthers() {
    ...
    // this._provider
    // );
    this._nft = new ethers.Contract(address, abi, this._provider);
    // const erc20 = new ethers.Contract(address, abi, this._provider);
  ...
  async _updateBalance() {
    const balance = await this._nft.balanceOf("0x30b133841c6ec175b57a629efccadaf3510d9a46");
  ...
  async _transferTokens(to, amount) {
    ...
    try {
      ...
      // const tx = await this._nft.transfer(to, amount);
